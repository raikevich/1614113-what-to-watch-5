        ...
        <div className="movie-card__wrap">
          <div className="movie-card__desc">
            ...
            <div className="movie-card__buttons">
              <Link to={`/player/${filmId}`} className="btn btn--play movie-card__button">
          ...
          <div className="movie-card__desc">
            ...
            <div className="movie-card__text">
              ...
              <p className="movie-card__starring">
                <strong>Starring: {film.starring}</strong></p>
            </div>
          </div>
        </div>
      </div>
...
Film.propTypes = Object.assign({}, propTypes.PropTypesFilms, propTypes.PropTypesReviews, propTypes.PropTypesFilmId);
